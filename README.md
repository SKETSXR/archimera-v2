...
This document will serve as a guide for all the documentations for the project.

For any clarifications, please contact [Ayush Kumar](mailto:ayushkum@griphic.com).

## List of Documentations

1. [High Level Documentation](./docs/high_level_documentation.md): This document details a high-level overview of the current strategy and architecture of our system. It is intended to act as a guide for stakeholders, developers, and new team members to understand the core components and their interactions.
